...
**This is the applied result of [fabric-sm-patch](https://github.com/flyinox/fabric-sm-patch). All right reserved for Author `flyinox`**
...
Issue tracking is handled in [Jira](https://jira.hyperledger.org/secure/Dashboard.jspa?selectPageId=10104).
